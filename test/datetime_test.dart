...
void main() {
  group('RFC 822 date time', () {
    test('parse GMT date time', () {
      const dateString = 'Sat, 29 Apr 2023 12:00:00 GMT';
    ...
    test('parse EST date time', () {
      const dateString = 'Sat, 29 Apr 2023 21:22:23 EST';
      final result = parseDateTime(dateString);
      expect(result, isNotNull);
      expect(result!.isUtc, true);
    ...
    test('parse +0000 offset date time', () {
      const dateString = 'Fri, 28 Apr 2023 23:00:57 +0000';
      final result = parseDateTime(dateString);
      expect(result, isNotNull);
      expect(result!.isUtc, true);
    ...
    test('parse -0000 offset date time', () {
      ...
      const dateString = 'Thu, 27 Apr 2023 19:17:00 -0000';
      final result = parseDateTime(dateString);
      expect(result, isNotNull);
      expect(result!.isUtc, true);
    ...
    test('parse +0100 offset date time', () {
      const dateString = 'Fri, 28 Apr 2023 19:02:17 +0100';
      final result = parseDateTime(dateString);
      expect(result, isNotNull);
      expect(result!.isUtc, true);
    ...
    test('parse 02:00 offset date time', () {
      const dateString = 'Thu, 27 Apr 2023 14:30:00 02:00';
      final result = parseDateTime(dateString);
      expect(result, isNotNull);
      expect(result!.isUtc, true);
    ...
    test('parse -0500 offset date time', () {
      const dateString = 'Thu, 27 Apr 2023 14:30:00 -0500';
      final result = parseDateTime(dateString);
      expect(result, isNotNull);
      expect(result!.isUtc, true);
  ...
  group('ISO 8601 date time', () {
    test('parse +00:00 offset date time', () {
      const dateString = '2023-04-24T05:02:37+00:00';
      final result = parseDateTime(dateString);
      expect(result, isNotNull);
      expect(result!.isUtc, true);
